...
export default function Formikk() {
    ...
    console.log(values ,"formikkvalues");
    return (
        <>
...
//         },
//     });
//     console.log(formikkkkkk.values, "values");
//     return (    
//         <>
//             <section className='m-10'>
...
//                                 </a>
//                             </p>
//                             <form action="#" method="POST" className="mt-8" onSubmit={formikkkkkk.handleSubmit}>
...
//                                                 placeholder="Email"
//                                                 name="email"
//                                                 onChange={formikkkkkk.handleChange}
//                                                 value={formikkkkkk.values.email}
//                                             />
//                                         </div>
//                                     </div>
//                                     <div>
...
//                                                 name="password"
//                                                 onChange={formikkkkkk.handleChange}
//                                                 value={formikkkkkk.values.password}
//                                             />
//                                         </div>
//                                     </div>
//                                     <div>
