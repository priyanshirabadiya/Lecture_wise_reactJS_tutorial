...
export default function Sign_in() {
    ...
    const getpassword = localStorage.getItem("Pw");
    ...
    const signindata = (e) => {
        ...
        } else if (email != getemail && Pw != getpassword) {
            Swal.fire({
                icon: "error",
                title: "Wrong details",
                text: "Fill the right details",
            });
        }
        else {
            Swal.fire({
                        ...
                        <div className='pt-10 ps-10 flex' >
                            ...
                            <div>
                                ...
                                <div className=' bg-white py-1 mt-5 rounded flex -ms-12 ' >
                                    ...
                                    <input type="email" onChange={(e) => setemail(e.target.value)} className='px-2 pe-72 py-3 focus:border-none focus:outline-none ' placeholder='Username/email address' />
                                </div>
                                <div className=' bg-white py-1 mt-3 rounded flex -ms-12' >
                                    <GoKey className='m-4 me-0 text-gray-500 ' />
                                    <input type="password" onChange={(e) => setpw(e.target.value)} className='px-2 pe-72 py-3 focus:border-none focus:outline-none ' placeholder='Password' />
                                </div>
                        ...
                        <div className='pt-10 ps-10 flex' >
                            ...
                            <div>
                                ...
                                <div className=' bg-white py-1 mt-5 rounded flex -ms-12' >
                                    ...
                                    <input type="email" className='px-2 pe-72 py-3 focus:outline-none focus:border-none' onChange={(e) => setemail(e.target.value)} placeholder='Username/email address' />
                                </div>
                                <div className=' bg-white py-1 mt-3 rounded flex -ms-12' >
                                    <GoKey className='m-4 me-0 text-gray-500 ' />
                                    <input type="password" className='px-2 pe-72 py-3 focus:border-none focus:outline-none ' onChange={(e) => setpw(e.target.value)} placeholder='Password' />
                                </div>
                                <div className="flex mt-5 justify-between -ms-12 n-check">
                                    <div className='' >
