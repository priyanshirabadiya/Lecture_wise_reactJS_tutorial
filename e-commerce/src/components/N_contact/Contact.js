      ...
      <div className="flex flex-wrap justify-center sm:justify-center md:justify-center lg:justify-between mt-14 mx-7">
        ...
        <div className='mb-5 md:mt-10 lg:mt-0 ' >
          ...
          <div className="flex flex-wrap mt-3">
            <input type="text" className='border p-4 placeholder:text-[0.9rem] w-[28vw] placeholder:text-gray-500 me-8 rounded' placeholder='Full name' />
            <input type="email" className='border p-4 placeholder:text-[0.9rem] w-[28vw] placeholder:text-gray-500 rounded' placeholder='Email address' />
          </div>
          <div className="flex flex-wrap mt-4">
            <input type="text" className='border p-4 placeholder:text-[0.9rem] w-[28vw] placeholder:text-gray-500 me-8 rounded' placeholder='Phone number' />
            <input type="text" className='border p-4 placeholder:text-[0.9rem] w-[28vw] placeholder:text-gray-500 rounded' placeholder='Subject' />
          </div>
          <input type="text" className='w-[50vw] h-[16.5rem] mt-4 border placeholder:ps-3 rounded  placeholder:text-[0.9rem]  placeholder:text-gray-500' placeholder='Enter message' />
          <button className='p-4 rounded w-[12vw] justify-center bg-[#d5123d] text-white border ll-1 mt-4 flex font-bold'><Link to="/error" >Get a Quote</Link><FaArrowRightLong className='ms-3 mt-1 right-animation ' /> </button>
        </div>
      </div>
      <div className=''>
