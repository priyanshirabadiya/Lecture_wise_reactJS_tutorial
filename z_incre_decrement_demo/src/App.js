...
import './App.css';
import Time from  './tasks/A_Time';
import Props from './tasks/B_cards'
import img from './assets/boy.webp';
import img2 from './assets/man.jpg';
import img3 from './assets/women.avif';
import TernaryOp from './tasks/C_Emojs';
import Textform from './tasks/D_incrementdec';

function App() {
  return (
    <>
    {/* good mrning / evening / nignt project */}
      {/* <Time></Time> */}
    ...
    {/* 3 cards project */}
      ...
      {/* Emojs logo compare equal or not  */}

      {/* <TernaryOp/> */}

      {/* increment derement project */}
      <Textform/>
