...
//     const [_, index] = task.name.split(" "); //it show that array ignore first part of arr split method split ['task','index']
//     console.log(task.name.split(" "));
...
export default class KanbanBoard extends Component {
  ...
  //   for (const s in stateCopy) {
  //     if (Number(s) === Number(index) && task.stage < this.stagesNames.length - 1) {
  //       task.stage += 1;
  //     }
  //   }
